...
public abstract class MicroService implements Runnable {
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        messageCallbackConcurrentHashMap.put(type, callback);
    ...
    /**
     start brod-listener brod1 2     * Signals the event loop that it must terminate after handling the current
     * message.
     */
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                messageCallbackConcurrentHashMap.get(m.getClass()).call(m);
