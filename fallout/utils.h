...
int compare_result(const unsigned char *s, const unsigned char letter, int length);

void data_bounce_s(void *buffer, void *from);
void time_buffer_single(struct hit_count *results, unsigned char *buffer, size_t x, uint64_t threshold);
